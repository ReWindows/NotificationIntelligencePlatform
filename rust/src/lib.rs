//! Windissect-generated Rust FFI bindings for NotificationIntelligencePlatform.dll. Windows only.
...
pub const EXPECTED_PDB_GUID: &str = "88BF8976400046F22C655574BA083A40";
pub const EXPECTED_PDB_AGE: u32 = 1;
pub const EXPECTED_PE_TIMESTAMP: u32 = 1011827848;
...
mod resolver {
    ...
    pub fn base() -> usize {
        ...
        let name: [u16; 37] = [78, 111, 116, 105, 102, 105, 99, 97, 116, 105, 111, 110, 73, 110, 116, 101, 108, 108, 105, 103, 101, 110, 99, 101, 80, 108, 97, 116, 102, 111, 114, 109, 46, 100, 108, 108, 0];
        ...
        if live_timestamp != 1011827848 { return 0; }
