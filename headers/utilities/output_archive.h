...
// Reconstructed from NotificationIntelligencePlatform.dll by Windissect. 19 member(s).
namespace tson {
...
public:
    ...
    // Category: Method | Source: PDB Internal
    // Symbol: ?saveValue@output_archive@tson@@QEAAXK@Z
    void saveValue(unsigned long);
    // Category: Method | Source: PDB Internal
