// Flat C exports observed in NotificationIntelligencePlatform.dll. Unknown ABIs are intentionally not declared.
// Validated dialects: ISO C17/C23/C26 draft and Windissect C20 (C ABI under C++20).
#pragma once
#ifndef NOTIFICATIONINTELLIGENCEPLATFORM_C_H
#define NOTIFICATIONINTELLIGENCEPLATFORM_C_H
...
#endif
#endif // NOTIFICATIONINTELLIGENCEPLATFORM_C_H
